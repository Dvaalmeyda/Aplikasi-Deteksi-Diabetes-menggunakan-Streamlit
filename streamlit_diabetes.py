...
#judul aplikasi
st.title('SISTEM PREDIKSI DIABETES MENGGUNAKAN ALGORITMA SVM')
...
if st.button('Tes Prediksi Diaberes'):
    diab_prediction = diabetes_model.predict([[Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age]])
    
    if(diab_prediction[0] ==1):
        diab_diagnosis = 'Pasien terindikasi Diabetes'
    else:
        diab_diagnosis = 'Pasien tidak terindikasi Diabetes'
